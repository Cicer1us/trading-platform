    ...
    <footer className={style.footer}>
      <div className={style.container}>
        <div className={style.linksContainer}>
          <Link href={BLOG} target="_blank" rel="noopener noreferrer" className={style.linksTitle}>
            {'Blog'}
          </Link>
          <Link href={TERMS} target="_blank" rel="noopener noreferrer" className={style.linksTitle}>
            {'Terms of Service'}
          </Link>
          <a
