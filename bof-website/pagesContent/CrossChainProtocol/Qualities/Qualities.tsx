      ...
      <div className={style.whyWrap}>
        <div className={style.cell}>
          <Image
            width={72}
            height={72}
            className={style.whyIcon}
            src="/images/cross-chain-landing/qualities/easy.png"
            alt="Image"
            loading="lazy"
          />
        ...
        <div className={style.cell}>
          <Image
            ...
            height={72}
            className={style.whyIcon}
            src="/images/cross-chain-landing/qualities/free.png"
            alt="Image"
            loading="lazy"
          />
        ...
        <div className={style.cell}>
          <Image
            ...
            height={72}
            className={style.whyIcon}
            src="/images/cross-chain-landing/qualities/evm.png"
            alt="Image"
            loading="lazy"
          />
        ...
        <div className={style.cell}>
          <Image
            ...
            height={72}
            className={style.whyIcon}
            src="/images/cross-chain-landing/qualities/reliable.png"
            alt="Image"
            loading="lazy"
          />
        ...
        <div className={style.cell}>
          <Image
            ...
            height={72}
            className={style.whyIcon}
            src="/images/cross-chain-landing/qualities/help.png"
            alt="Image"
            loading="lazy"
          />
