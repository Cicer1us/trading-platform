...
const abi: AbiItem[] = [
	{
		inputs: [{ internalType: 'address payable', name: '_feeWallet', type: 'address' }],
	...
	{
		anonymous: false,
		inputs: [{ indexed: true, internalType: 'address', name: 'router', type: 'address' }],
		...
		outputs: [
			{
				components: [
					...
					{ internalType: 'bool', name: 'noPositiveSlippage', type: 'bool' },
					{ internalType: 'bool', name: 'positiveSlippageToUser', type: 'bool' },
					{ internalType: 'uint16', name: 'feePercent', type: 'uint16' },
					{ internalType: 'string', name: 'partnerId', type: 'string' },
	...
	},
	{
		inputs: [
			...
			{ internalType: 'uint256', name: '_partnerShare', type: 'uint256' },
			{ internalType: 'bool', name: '_noPositiveSlippage', type: 'bool' },
			{ internalType: 'bool', name: '_positiveSlippageToUser', type: 'bool' },
